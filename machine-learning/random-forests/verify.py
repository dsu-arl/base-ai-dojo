...
class Validator:
    ...
    def step_1_check(self) -> Tuple[bool, str]:
        """Step Goal: Split the dataset where the test dataset is 30% of the original
        dataset with a random state of 23.
    ...
    def step_4_check(self) -> Tuple[bool, str]:
        """Step Goal: Make predictions on the test dataset using the trained random
        forest model.
