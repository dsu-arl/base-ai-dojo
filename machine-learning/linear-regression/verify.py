...
class Validator:
    ...
    def step_4_check(self) -> Tuple[bool, str]:
        """Step Goal: Make predictions on the test dataset using the trained linear
        regression model.
    ...
    def step_5_check(self) -> Tuple[bool, str]:
        """Step Goal: Get the mean squared error from the test dataset and the linear
        ...
        self.user_vars.mse = statement.targets[0]
        return True, ""
    ...
    def step_6_check(self) -> Tuple[bool, str]:
        ...
        if function_call.args != [self.user_vars.mse]:
